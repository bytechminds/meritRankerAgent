...
| GPT-4.1 | math.generator.advanced | `QUALIFIED` | Incumbent. Frozen. Terra challenged and failed. 2026-09-24 frozen corpus of 105 real advanced slots: 33% exhausted all three attempts; the Authority was correct on every inspected rejection (80% an omitted correct answer from uncomputed arithmetic) |
| GPT-6 Sol (medium) | practice_math.generator.advanced (Practice advanced Math authoring) | `QUALIFIED` | Promoted 2026-09-24 on a Practice-only route; Doubt Solver keeps math.generator.advanced on GPT-4.1. Frozen 105-slot corpus on the production route: 105/105 first pass (GPT-4.1: 51 first pass, 68 eventual, 37 exhausted), 0 structural failures, 0/22 false approvals on manual check, p50 7.0 s / p95 11.0 s, $0.0105 per accepted question |
