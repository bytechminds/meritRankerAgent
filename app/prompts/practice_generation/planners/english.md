...
- Use canonical lowercase underscore IDs and `subject_id=english`.
- Use the supplied difficulty.
...
- Distinguish repeats through `target_skill`, `pattern_hint`, and `not_same_when`.
